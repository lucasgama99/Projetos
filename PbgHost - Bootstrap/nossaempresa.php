...
<head>
	...
	<title>Portal Brasil Games - Nossa Empresa</title>
	<!-- ***** Bootstrap ***** -->
    <link rel="stylesheet" href="plugins/bootstrap/css/bootstrap.css">
    <!-- ***** Font Awesome ***** -->
    <link rel="stylesheet" type="text/css" href="fonts/Awesome/css/font-awesome.min.css">
	<!-- ***** CSS ***** -->
	<link rel="stylesheet" type="text/css" href="css/nossaempresa-style.css">
	...
	<main class="content">
        <div class="bloc l-bloc">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <img src="img/construcao.jpg" height="720" width="1280">
                    </div>
                </div>
            </div>
        </div>
